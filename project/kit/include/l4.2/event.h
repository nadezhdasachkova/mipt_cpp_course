...
// ЗАНЯТИЕ 4.2. Принимает string_view, а не строку, и причина
// в загрузчике правил: он режет текст конфигурации взглядами
// и спрашивает тип события от куска этого текста. Заводить ради
// одного сравнения std::string было бы аллокацией на каждое условие
// в файле. Всё остальное в этом заголовке владеет своими строками
// по-прежнему.

...
// больше не компилируются. Это нормальная цена смены способа сообщить
// об ошибке, и она заранее известна — набор 2.1 подключается на 4.2
// без своего файла обёртки.
//
